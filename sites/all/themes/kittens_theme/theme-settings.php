 ...
 */
function kittens_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['kittens_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('kittens_theme sample setting'),
  '#default_value' => theme_get_setting('kittens_theme_example'),
